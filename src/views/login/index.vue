<template>
  <div class="login-container">
    ...
    <div class="footText">技术支持：南京德益康信息技术有限公司<span class="footbb">版本号：1.0</span></div>
...
.login-container {
  ...
  .loginBox {
    width: 1387px;
    height: 700px;
    background-image: url("~@/assets/login/Rectangle 1561.png");
    display: flex;
    margin: 0 auto;
    margin-top: 120px;
    .leftBox {
      width: 634px;
      height: 700px;
      background-image: url("~@/assets/login/logImg.png");
